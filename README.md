# Student ML API — CI/CD, Docker & MLOps Assignment
...
| Build | Time |
|---|---:|
| Cold build | 40.210 seconds |
| Cached build | 2.537 seconds |
...
3. Determines the semantic image version.
4. Builds the Docker image.
5. Supplies OCI metadata build arguments.
6. Pushes the versioned image.
7. Updates the `latest` tag.
...
- [x] Clone repository
- [x] Inspect Git history
- [x] Inspect Pull Requests
- [x] Inspect GitHub Actions
- [x] Pull versioned Docker image
- [x] Run container
- [x] Test `/health`
- [x] Test `/predict`
- [x] Demonstrate rollback
- [x] Verify Git tags `v1.0.0` and `v1.1.0`
- [x] Verify registry artifacts `1.0.0`, `1.1.0`, and `latest`
- [x] Demonstrate Docker build caching
- [x] Demonstrate OCI metadata and source traceability
